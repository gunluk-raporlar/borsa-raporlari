...
DIL = {
    ...
    "ru": {
        "ad": "Russian", "html_lang": "ru", "og_locale": "ru_RU", "onluk": ",",
        "yerel": "ru-RU", "yukleniyor": "Загрузка...", "hava_yukleniyor": "Погода в Стамбуле...",
        "site_adi": "BIST 30 Ежедневные отчёты",
        "nav_ana": "Главная", "nav_raporlar": "Отчёты", "nav_hisseler": "Акции",
        "diller": "Языки",
        "ana_baslik": "BIST 30 Ежедневные отчёты — анализ турецкого фондового рынка на основе ИИ",
        "ana_tanim": "Ежедневный анализ BIST 30 (Стамбульская фондовая биржа) на русском языке: технический скрининг, сигналы осцилляторов, модельный портфель и виртуальное отслеживание портфеля — каждый торговый день генерируется многоагентной системой ИИ.",
        "hero_baslik": "Ежедневный анализ BIST 30 на основе ИИ",
        "hero_alt": "Индекс BIST 30 Стамбульской фондовой биржи ежедневно разбирается многоагентной системой ИИ: рыночный отчёт, технический скрининг и сигналы осцилляторов. Новый отчёт в каждый торговый день в 08:00 (Стамбул).",
        "son_raporlar": "Архив отчётов",
        "rapor_link": "Открыть ежедневный отчёт &rarr;",
        "arsiv_yok": "Отчётов пока нет — первый переведённый отчёт появится после следующего запуска бота.",
        "paket_basligi": "Сегодняшний обзор BIST 30",
        "yukselenler": "Лидеры роста", "dusenler": "Лидеры падения",
        "hisse_git": "Открыть полную техническую таблицу BIST 30 &rarr;",
        "one_cikanlar": "Лучшее в техническом скрининге",
        "one_cikanlar_not": "Страницы акций пока доступны только на турецком языке.",
        "hisse_baslik": "Акции BIST 30 — технические сигналы",
        "hisse_tanim": "Ежедневные технические сигналы по акциям BIST 30: оценка тренда, динамика за день и 60 дней, общий сигнал.",
        "hisse_not": "Подробные страницы акций пока доступны только на турецком; таблица ниже — обзор на русском.",
        "th": ["Тикер", "Последняя", "День %", "60 дней %", "Сигнал"],
        "rapor_baslik": "Рыночный отчёт",
        "rapor_alt": "Ежедневный анализ BIST 30 на основе ИИ",
        "rapor_tanim": "Ежедневный отчёт по рынку BIST 30 за {t} на основе ИИ: краткое резюме, обзор макроэкономики и новостей, технический разбор акций и взгляд на модельный портфель.",
        "geri": "&larr; Назад ко всем отчётам",
        "tr_git": "Турецкая версия",
        "footer": "Вся информация, комментарии и рекомендации на этой странице носят исключительно информационный характер и не являются инвестиционной консультацией или инвестиционной рекомендацией. Точность данных не может быть гарантирована; ответственность за любые принятые решения несёт пользователь.",
    },
}
...
SINYAL = {
    ...
    "ru": {'GÜÇLÜ AL': 'Активно покупать', 'AL': 'Покупать', 'NÖTR': 'Нейтрально', 'SAT': 'Продавать', 'GÜÇLÜ SAT': 'Активно продавать'},
}
...
def _dil_bar(kok, aktif):
    ...
    for d, bayrak, ad in (("en", "🇬🇧", "English"), ("de", "🇩🇪", "Deutsch"),
                          ("zh", "🇨🇳", "中文"), ("ru", "🇷🇺", "Русский")):
